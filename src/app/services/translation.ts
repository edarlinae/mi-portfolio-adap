...
export class TranslationService {
  ...
  private translations: Record<Language, Translations> = {
    es: {
      ...
      hero_subtitle: 'Desarrolladora dedicada a transformar diseños en experiencias de usuario intuitivas y accesibles, construyendo aplicaciones robustas con tecnología web moderna.',
    ...
    en: {
      ...
      nav_contact: 'Contact',
      hero_subtitle: 'Developer dedicated to transforming designs into intuitive and accessible user experiences, building robust applications with modern web technology.',
    ...
    fr: {
      ...
      nav_contact: 'Contact',
      hero_subtitle: 'Développeuse dédiée à transformer des designs en expériences utilisateur intuitives et accessibles, en créant des applications robustes avec la technologie web moderne.',
    ...
    ca: {
      ...
      hero_subtitle: 'Desenvolupadora dedicada a transformar dissenys en experiències d\'usuari intuïtives i accessibles, construint aplicacions robustes amb tecnologia web moderna.',
    ...
    gl: { 
      ...
      nav_contact: 'Contacto',
      hero_subtitle: 'Desenvolvedora dedicada a transformar deseños en experiencias de usuario intuitivas e accesibles, construíndo aplicacións robustas con tecnoloxía web moderna.',
